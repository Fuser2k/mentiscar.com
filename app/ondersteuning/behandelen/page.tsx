...
export default function BehandelenPage() {
    return (
            ...
            <main className="flex-grow pt-24 md:pt-32">
                ...
                <div className="container mx-auto px-4 md:px-6 mb-8">
                    <nav className="flex items-center text-sm text-gray-500">
                        ...
                        <ChevronRight size={14} className="mx-2" />
                        <span className="text-navy font-medium">Behandelen</span>
                    </nav>
                </div>
                ...
                <div className="container mx-auto px-4 md:px-6 mb-16 md:mb-24 relative">
                    ...
                    <div className="relative z-10 pl-8 md:pl-12 border-l-4 border-teal/20">
                        ...
                        <div className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-5xl space-y-6">
                            <p>
                                Bij Mentis Care staat begeleiding centraal. Wij bieden zelf geen specialistische behandeling of therapie voor kinderen, jongeren of volwassenen.
                            </p>
                            <p>
                                Wel spelen wij een belangrijke rol in het ondersteunen van cliënten die behandeling ontvangen bij andere zorgverleners. Onze begeleiding helpt cliënten om grip te houden op het dagelijks leven, structuur aan te brengen en afspraken rondom behandeling vol te houden.
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
                            <div>
                                <h2 className="text-3xl md:text-4xl font-bold text-navy mb-6">
                                    Ondersteuning bij grip op het leven
                                </h2>
                                <div className="prose prose-lg text-gray-600">
                                    <p className="mb-4">
                                        Wanneer iemand te maken heeft met psychische problematiek, een verstandelijke beperking of complexe zorgvragen, kan het dagelijks functioneren onder druk komen te staan.
                                    </p>
                                    <p>
                                        Mentis Care ondersteunt cliënten bij het organiseren van het leven rondom deze uitdagingen. Samen kijken we naar wat nodig is om stabiliteit te creëren, bijvoorbeeld op het gebied van wonen, daginvulling, sociale contacten en praktische zaken.
                                    </p>
                                </div>
                            </div>
                            <div className="relative h-[400px] w-full rounded-3xl overflow-hidden shadow-xl">
                                <ImageWithFallback
                                    src="/assets/ondersteuning-grip-leven.png" // Support/Conversation
                                    alt="Ondersteuning bij grip op het leven"
                    ...
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
                            <div className="order-2 md:order-1 relative h-[400px] w-full rounded-3xl overflow-hidden shadow-xl">
                                <ImageWithFallback
                                    src="/assets/behandelen.png" // Professional collaboration
                                    alt="Afstemming met behandeling"
                                    className="object-cover w-full h-full hover:scale-105 transition-transform duration-700"
                                />
                            </div>
                            <div className="order-1 md:order-2">
                                <h2 className="text-3xl md:text-4xl font-bold text-navy mb-6">
                                    Afstemming met behandeling
                                </h2>
                                <p className="text-lg text-gray-600 mb-6">
                                    Mentis Care werkt samen met externe behandelaren en betrokken instanties, zoals:
                                </p>
                                <ul className="space-y-4 mb-8">
                                    {[
                                        "Huisartsen en medisch specialisten",
                                        "GGZ-instellingen en behandelpraktijken",
                                ...
                                <p className="text-navy font-medium italic">
                                    Wij stemmen onze begeleiding af op lopende behandeltrajecten, zodat cliënten één samenhangend en overzichtelijk ondersteuningsproces ervaren. Waar passend betrekken we familie, naasten of wettelijk vertegenwoordigers bij de begeleiding.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <div className="text-xl text-gray-600 leading-relaxed space-y-6">
                                <p>
                                    Mentis Care begeleidt (jong)volwassenen met een WLZ-indicatie die ondersteuning nodig hebben bij het dagelijks functioneren.
                                </p>
                                <p>
                                    Bij multiproblematiek – bijvoorbeeld een combinatie van psychische problematiek en een verstandelijke beperking – bieden wij intensieve begeleiding in combinatie met externe behandeling. De begeleiding kan plaatsvinden op een woonlocatie of in de directe leefomgeving van de cliënt.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <Section background="soft-white" className="py-12 md:py-20">
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
                            <div>
                                <h2 className="text-3xl md:text-4xl font-bold text-navy mb-6">
                                    Geen behandeling voor kinderen en jongeren
                                </h2>
                                <div className="prose prose-lg text-gray-600">
                                    <p>
                                        Mentis Care biedt geen behandeling of begeleiding aan kinderen en jongeren. Wanneer sprake is van een jeugdvraag, denken wij wel mee over passende doorverwijzing naar gespecialiseerde jeugdzorg of behandelaanbieders.
                                    </p>
                                </div>
                            </div>
                            <div className="relative h-[400px] w-full rounded-3xl overflow-hidden shadow-xl">
                                <ImageWithFallback
                                    src="https://images.unsplash.com/photo-1536640712-4d4c36ff0d71?q=80&w=1000&auto=format&fit=crop" // Abstract/Path/Choice
                                    alt="Geen behandeling voor kinderen"
                                    className="object-cover w-full h-full hover:scale-105 transition-transform duration-700"
                                />
                            </div>
                        </div>
                ...
                <Section background="white" className="py-12 md:py-20">
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
                            <div className="order-2 md:order-1 relative h-[400px] w-full rounded-3xl overflow-hidden shadow-xl">
                                <ImageWithFallback
                                    src="/assets/werkgebied.png" // City/Architecture/Rotterdam feel
                                    alt="Werkgebied"
                                    className="object-cover w-full h-full hover:scale-105 transition-transform duration-700"
                                />
                            </div>
                            <div className="order-1 md:order-2">
                                ...
                                <div className="prose prose-lg text-gray-600">
                                    <p>
                                        Mentis Care is actief in Rotterdam en omliggende gemeenten. Onze begeleiding vindt plaats op woonlocaties en in de leefomgeving van cliënten, in nauwe samenwerking met betrokken zorgpartners.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4 md:px-6 pb-20 pt-10 text-center relative">
                    <div className="max-w-6xl mx-auto relative flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12">
                        ...
                        <p className="text-3xl md:text-4xl font-serif text-teal italic font-light max-w-4xl leading-tight relative z-10">
                            "Mentis Care – begeleiding in verbinding met behandeling, gericht op stabiliteit en dagelijks leven."
                        </p>
