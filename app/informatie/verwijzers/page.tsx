...
export default function VerwijzersPage() {
    const stepsData = [
        {
            title: "Stap 1 – Contact en aanmelding",
            description: "U kunt als verwijzer contact met ons opnemen om een cliënt aan te melden of een casus te bespreken."
        },
        {
            title: "Stap 2 – Kennismaking",
            description: "Na aanmelding nemen wij contact op met de cliënt voor een kennismakingsgesprek."
        },
        {
            title: "Stap 3 – Afstemming van de zorg",
            description: "Samen onderzoeken we welke ondersteuning passend is. Dit kan worden aangevuld met een locatiebezoek."
        },
        {
            title: "Stap 4 – Start van de ondersteuning",
            description: "Wanneer de zorg passend is en er ruimte is, worden afspraken gemaakt over de start en inhoud van de begeleiding. Eventuele wachttijd wordt transparant besproken."
        }
    ];
            ...
            <main className="flex-grow pt-24 md:pt-32">
                ...
                <div className="container mx-auto px-4 md:px-6 mb-8">
                    <nav className="flex items-center text-sm text-gray-500">
                        ...
                        <ChevronRight size={14} className="mx-2" />
                        <span className="text-navy font-medium">Verwijzers</span>
                    </nav>
                </div>
                ...
                <div className="container mx-auto px-4 md:px-6 mb-16 md:mb-24 relative">
                    ...
                    <div className="relative z-10 pl-8 md:pl-12 border-l-4 border-teal/20">
                        ...
                        <div className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-5xl space-y-6">
                            <p>
                                Als verwijzer wilt u kunnen rekenen op een zorgorganisatie die betrouwbaar, deskundig en helder werkt. Mentis Care biedt een professioneel partnerschap, korte lijnen en duidelijke communicatie.
                            </p>
                            <p>
                                Samen zorgen we voor passende ondersteuning voor mensen met een langdurige zorgvraag. Wij denken graag mee over complexe situaties en zoeken samen naar oplossingen die aansluiten bij de indicatie, de mogelijkheden van de cliënt en de regionale context.
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
                            <div>
                                ...
                                <div className="prose prose-lg text-gray-600">
                                    <p className="mb-4">
                                        Mentis Care biedt begeleiding en zorg binnen de Wet langdurige zorg (WLZ) voor (jong)volwassenen met een verstandelijke beperking, psychische problematiek of een combinatie hiervan.
                                    </p>
                                    <p className="mb-4">
                                        Onze ondersteuning richt zich op wonen, structuur, daginvulling en participatie. We werken maatgericht en stemmen de zorg af op de doelen van de cliënt, met aandacht voor zelfstandigheid, stabiliteit en kwaliteit van leven.
                                    </p>
                                    <p>
                                        Waar nodig werken wij samen met behandelaren en andere betrokken professionals om integrale ondersteuning te bieden.
                                    </p>
                                </div>
                            </div>
                            <div className="relative h-[400px] w-full rounded-3xl overflow-hidden shadow-xl">
                                <ImageWithFallback
                                    src="/assets/begeleiding-ondersteuning.png" // Medical/Professional/Notebook
                                    alt="Passende zorg en begeleiding"
                    ...
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
                            <div className="order-2 md:order-1 relative h-[400px] w-full rounded-3xl overflow-hidden shadow-xl">
                                <ImageWithFallback
                                    src="/assets/samenwerken-doorverwijzing.png" // Handshake/Meeting
                                    alt="Samenwerking met verwijzers"
                                    className="object-cover w-full h-full hover:scale-105 transition-transform duration-700"
                                />
                            </div>
                            <div className="order-1 md:order-2">
                                ...
                                <div className="prose prose-lg text-gray-600">
                                    <p className="mb-4">
                                        Wij zien verwijzers als belangrijke samenwerkingspartners. Heldere afstemming, transparantie en bereikbaarheid staan daarbij centraal.
                                    </p>
                                    <p>
                                        Wilt u overleggen over een casus, sparren over mogelijkheden of een cliënt aanmelden? Dan kunt u rechtstreeks contact opnemen met Mentis Care. U krijgt contact met een inhoudelijk deskundige medewerker die met u meedenkt over passende vervolgstappen.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                {/* Section C: Steps timeline (Full width) */}
                <Section background="navy" className="py-20 md:py-32 text-white overflow-hidden relative">
                    ...
                    <div className="container mx-auto px-4 md:px-6 relative z-10">
                        ...
                        <p className="text-center text-gray-300 mb-16 max-w-2xl mx-auto text-lg">
                            Een helder en zorgvuldig proces voor de beste start.
                        </p>
                        ...
                        <div className="mt-16 text-center">
                            <Link href="/contact" className="inline-flex items-center text-teal hover:text-white font-bold text-lg transition-colors border-b-2 border-teal pb-1 hover:border-white">
                                Direct contact opnemen <ChevronRight className="ml-2" size={20} />
                            </Link>
                        </div>
                    </div>
                </Section>
                    ...
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
                            <div>
                                ...
                                <div className="prose prose-lg text-gray-600">
                                    <p className="mb-4">
                                        Mentis Care werkt vanuit een mensgerichte en professionele visie. We kijken niet alleen naar de zorgvraag, maar naar de mens achter de indicatie. Daarbij staan stabiliteit, ontwikkeling en eigen regie centraal.
                                    </p>
                                    <p>
                                        Het sociale netwerk van de cliënt is waar mogelijk een belangrijk onderdeel van de ondersteuning. We werken samen met naasten en betrokken partijen om duurzame zorg te realiseren. Digitale middelen zetten we ondersteunend in waar dit bijdraagt aan overzicht, communicatie en zelfredzaamheid.
                                    </p>
                                </div>
                            </div>
                            <div className="relative h-[400px] w-full rounded-3xl overflow-hidden shadow-xl">
                                <ImageWithFallback
                                    src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=1000&auto=format&fit=crop" // Collaboration/Planning
                                    alt="Onze uitgangspunten"
                                    className="object-cover w-full h-full hover:scale-105 transition-transform duration-700"
                                />
                            </div>
                        </div>
                ...
                <Section background="soft-white" className="py-12 md:py-20">
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
                            <div className="order-2 md:order-1 relative h-[400px] w-full rounded-3xl overflow-hidden shadow-xl">
                                <ImageWithFallback
                                    src="/assets/voor-wie-is-mentis-care-alt.png" // Diverse group/Team
                            ...
                            <div className="order-1 md:order-2">
                                ...
                                <div className="prose prose-lg text-gray-600 mb-8">
                                    <p>
                                        Mentis Care richt zich op (jong)volwassenen vanaf 18 jaar met een WLZ-indicatie (VG en/of GGZ). Wij bieden ondersteuning aan cliënten met:
                                    </p>
                                </div>
                                ...
                                <p className="text-navy font-medium italic">
                                    Onze zorg is gericht op begeleid wonen, intramurale zorg en dagbesteding.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="max-w-4xl mx-auto text-center">
                            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-navy">
                                Werkgebied en netwerk
                            </h2>
                            <div className="text-xl text-gray-600 leading-relaxed space-y-6 mb-8">
                                <p>
                                    Mentis Care is actief in Rotterdam en omliggende gemeenten. Onze locaties bevinden zich in reguliere woonwijken en zijn onderdeel van de lokale omgeving.
                                </p>
                                <p>
                                    Wij werken samen met gemeenten, zorgkantoren, woningcorporaties en andere zorg- en welzijnspartners. Door samen te werken binnen regionale netwerken dragen wij bij aan samenhangende en toekomstbestendige zorg.
                                </p>
                            </div>
                            <p className="text-lg md:text-xl font-medium text-teal italic">
                                Wilt u meer weten of een cliënt aanmelden? Neem gerust contact met ons op. Wij denken graag met u mee.
                            </p>
                        </div>
                    </div>
                </Section>
                ...
                <div className="container mx-auto px-4 md:px-6 pb-20 pt-10 text-center relative">
                    <div className="max-w-6xl mx-auto relative flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12">
                        ...
                        <p className="text-3xl md:text-4xl font-serif text-teal italic font-light max-w-4xl leading-tight relative z-10">
                            "Mentis Care – een betrokken partner in langdurige zorg."
                        </p>
